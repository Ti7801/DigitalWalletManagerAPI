...
{
    public class ConsultarTransferenciasServices
    {
        private readonly ITransferenciaRepository _transferenciaRepository;
        private readonly ICarteiraDigitalRepository _carteiraDigitalRepository; 
        private readonly ILogger<ConsultarTransferenciasServices> _logger;

        public ConsultarTransferenciasServices(ITransferenciaRepository transferenciaRepository,
                                               ICarteiraDigitalRepository carteiraDigitalRepository,
                                               ILogger<ConsultarTransferenciasServices> logger) 
        {
